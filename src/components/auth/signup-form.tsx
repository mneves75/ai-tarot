 ...
 *
 * Premium glass morphism styled signup form with full i18n support.
...
export function SignupForm({ error: urlError }: SignupFormProps) {
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="h-11 bg-white/5 border-white/10 text-white placeholder:text-white/30 focus:border-purple-500/50 focus:ring-purple-500/20"
          />
          <p className="text-xs text-white/40">{t("auth.minPassword")}</p>
        </div>
